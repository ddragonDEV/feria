...
namespace FeriaUC\AdminBundle\Command;
...
// Change the namespace according to your bundle
use FeriaUC\AdminBundle\Sockets\Chat;
...
class SocketCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        // $app = new App('dev.feriauc.love.cl', 8484);
        ...
        $server = IoServer::factory(new HttpServer($ws), 8484);
        $server->run();
